...
public:
  CompilerInvocation() : AnalyzerOpts(new AnalyzerOptions()), Overlay(new vfs::OverlayFileSystem(vfs::getRealFileSystem())) {}
  ...
  void addOverlay(IntrusiveRefCntPtr<vfs::FileSystem> FS) {
